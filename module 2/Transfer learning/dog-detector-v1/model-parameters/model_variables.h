...
const char* ei_classifier_inferencing_categories[] = { "background", "dog" };
...
const ei_impulse_t impulse_531917_0 = {
    .project_id = 531917,
    .project_owner = "ramzi amira",
    .project_name = "dog-detector",
    .impulse_id = 1,
...
ei_impulse_handle_t impulse_handle_531917_0 = ei_impulse_handle_t( &impulse_531917_0 );
ei_impulse_handle_t& ei_default_impulse = impulse_handle_531917_0;
